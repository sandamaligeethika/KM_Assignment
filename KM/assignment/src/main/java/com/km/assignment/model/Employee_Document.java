...
public class Employee_Document {
    ...
    @Lob
    private byte[] employeeDocumentFile;

    public Employee_Document(){

    }

    public Employee_Document(Date dateTime, String fileType, String employeeDocumentFileName, String category, String description, long fileSize, String employeeManagementPerson, byte[] employeeDocumentFile) {
        ...
        this.employeeDocumentFile = employeeDocumentFile;
    }
    ...
    public byte[] getEmployeeDocumentFile() {
        return employeeDocumentFile;
    }

    public void setEmployeeDocumentFile(byte[] employeeDocumentFile) {
        this.employeeDocumentFile = employeeDocumentFile;
    }
}
